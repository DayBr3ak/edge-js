...
static napi_value initializeClrFunc(napi_env env, napi_callback_info info) {
    #ifdef HAVE_NATIVECLR
        #ifdef HAVE_CORECLR
...
napi_value Init(napi_env env, napi_value exports) {
    ...
    napi_status status;
    status = CallbackHelper::Initialize(env);
    ...
    napi_property_descriptor desc =
        {"initializeClrFunc", nullptr, initializeClrFunc, 0, 0, 0, napi_default, 0};
