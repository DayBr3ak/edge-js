...
napi_status ClrFunc::Initialize(napi_env env, System::Func<System::Object^,System::Threading::Tasks::Task<System::Object^>^>^ func, napi_ref *ref) {
...
napi_status ClrFunc::Initialize(napi_env env, napi_callback_info info) {
