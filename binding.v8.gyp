...
##
{
  'targets': [
    ...
    },
    {
      ...
      'sources+': [
        'src_napi/common/bindings.cpp',
        'src_napi/core-clr/core-clr-embedding.cpp',
        'vendors/host/coreclr.cpp',
        'vendors/host/args.cpp',
        'vendors/host/libhost.cpp',
        'vendors/host/runtime_config.cpp',
        'vendors/pal/pal_utils.cpp',
        'vendors/pal/trace.cpp',
        'vendors/fxr/fx_muxer.cpp',
        'vendors/fxr/fx_ver.cpp',
        'vendors/json/casablanca/src/json/json_parsing.cpp',
        'vendors/json/casablanca/src/json/json_serialization.cpp',
        'vendors/json/casablanca/src/json/json.cpp',
        'vendors/json/casablanca/src/utilities/asyncrt_utils.cpp',
        'vendors/deps/deps_entry.cpp',
        'vendors/deps/deps_format.cpp',
        'vendors/deps/deps_resolver.cpp'
      ],
      'include_dirs+': [
        'vendors/json/casablanca/include',
        'vendors'
      ],
      'conditions': [
        [
          ...
          {
            'sources+': [
              'vendors/pal/pal.windows.cpp'
            ]
          },
          {
            'sources+': [
              'vendors/pal/pal.unix.cpp'
            ]
          }
        ]
      ],
